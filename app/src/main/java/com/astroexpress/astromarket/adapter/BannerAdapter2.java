...
//import com.astroexpress.astromarket.model.BannerModel2;
...
//
//    Context context;
//    List<BannerModel2> bannerModels;
//
//    public BannerAdapter2(Context context, List<BannerModel2> bannerModels) {
...
//        Glide.with(context)
//                .load(bannerModels.get(position).getImg())
//                .centerCrop()
